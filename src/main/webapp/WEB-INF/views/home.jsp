...
<div class="container">
	...
	<!-- 
		Spring MVC에서는 이미지와 같은 정적 리소스를 사용하기 위해
		별도의 resources폴더를 제공한다.
		해당 폴더의 매핑은 sevlet-context.xml에서 변경하거나 추가할 수 있다.
	 -->
	<h3>resources 폴더 사용하기</h3>
	<!-- 
		views폴더 하위에 있는 해당 이미지는 출력되지 않는다.
		views폴더는 View파일 ;jsp만 위치할 수 있다.
	 -->
	<img src="./img_avatar1.png" alt="부트스트랩 아바타1" /><br>
	<!-- 
		원래의 폴더명은 resources이지만 아래와 같이
		sevlet-context.xml에서 개발자가 별도로 별칭을 부여해서 매핑할 수 있다.
	 -->
...
<!-- 컨트롤러 : FormController.java -->
	...
	<h3>Enviroment 객체를 이용한 외부파일 참조하기</h3>
	<li>
	...
	<li>
		<a href="./service/myService.do" target="_balnk">
			myService 바로가기
		</a>
	</li>
	<li>
	...
	<li>
		...
		&nbsp;&nbsp;&nbsp;
		<a href="./static/found.html" target="_blank">static 별칭 사용가능</a>
	</li>
	<!-- 
		webapp하위에서 JSP파일은 사용할 수 있다.
		jsp이므로 스크립트릿이나 클래스 임포트 등도 모두 가능하다.
	 -->
	<li>
