...
public class ValidateController {
	...
	/*
	메소드의 첫번째 파라미터
		: 폼값을 커맨드 객체(MemberDTO)를 통해 한번에 받은후
		  @ModelAttribute 어노테이션으로 모델객체에 저장시 mInfo로 이름을 변경한다.
	두번째 파라미터
		: BindingResult 객체는 validator를 통해 폼값을 검증한 후 해당 결과를 전송받을 객체로,
